  ...
  return (
    <div className="bg-white rounded-lg p-4 shadow-sm">
      ...
      <div className="space-y-6">
        {newsItems.map((item) => (
          <div key={item.id} className="flex gap-3 cursor-pointer hover:bg-gray-50 rounded-md transition-colors p-1">
            ...
            <div className="w-2/3 flex flex-col">
              ...
              <h3 className="font-bold text-[15px] mb-2 leading-tight">{item.title}</h3>
